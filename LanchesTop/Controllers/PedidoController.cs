...
namespace LanchesTop.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public IActionResult Checkout(Pedido pedido)
        {
            ...
            //verifica se tem itens de pedido no carrinho e define model state inválido para verificação posterior
            ...
            //valida os dados do pedido via model state
            if (ModelState.IsValid)
            {
                ...
                //retorna a view com dados do cliente e pedido
